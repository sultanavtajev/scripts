...
$runningProcesses = Get-Process | Select-Object Name, Id | ForEach-Object { "$($_.Name),$($_.Id)" }
...
$body = @{
    fields = @{
        ...
        runningProcesses = @{ arrayValue = @{ values = $runningProcesses | ForEach-Object { @{ stringValue = $_ } } } }
    }
